...
This repository is a private learning archive and educational documentation space. It keeps course completions, certificates, platform badges, lab material, notes, roadmaps, and study resources organized for long-term growth.

The goal is not just to collect badges. The goal is to document learning progress in a way that is easy to browse, easy to expand, and useful when reviewing backend engineering, cloud, cybersecurity, databases, and AI foundations.

---

<a id="learning-areas"></a>

## 🧭 Learning Areas

| Area | Focus |
| --- | --- |
| ☁️ AWS | Cloud foundations, AWS certification paths, architecture basics |
| 🟦 Microsoft | Azure, Microsoft Learn, Microsoft 365, Power Platform, Fabric |
| 🌐 NetAcad | Cisco Networking Academy, networking, cybersecurity, programming essentials |
| 💻 Backend | APIs, OOP, clean code, layered architecture, Programming Advices |
| 🔐 Cybersecurity | Networking, Wireshark, Linux, CompTIA-aligned fundamentals |
| 🗄️ Databases | SQL, relational design, database projects, data platforms |
| 🤖 AI | Azure AI, AWS AI, LLM tooling, backend AI integrations |
| 🤝 Soft Skills | Communication, English, leadership, productivity, business analysis |
| 📦 Misc | General digital skills, creative tools, and uncategorized learning |

---

<a id="archive-structure"></a>
...
Category folders live inside `Learning-Archive` so the repository root stays clean. Existing badge assets remain in `assets/badges` to preserve local paths and avoid breaking images.
...
Certificates and badges are grouped by platform, provider, or topic. Some items are official certifications, while others are course completions, learning paths, self-study programs, or platform badges.
...
<p align="left">
  ...
  <a href="https://learn.microsoft.com/en-us/credentials/certifications/copilot-and-agent-administration-fundamentals/" target="_blank"><img src="./assets/badges/AB-900-Copilot-Agent-Administration-742774-44a07a9c.svg" alt="AB-900"></a>
  <a href="https://learn.microsoft.com/en-us/credentials/certifications/power-platform-fundamentals/" target="_blank"><img src="./assets/badges/PL-900-Power-Platform-Fundamentals-742774-ebd4984c.svg" alt="PL-900"></a>
...
Learning notes are for summaries, revision checklists, commands, implementation notes, course takeaways, and topic references.
...
Labs are for hands-on work: backend API exercises, deployment experiments, database practice, screenshots, commands, packet captures, Linux/security tasks, and cloud exercises.
...
Roadmaps track long-term learning paths and next steps.
...
Resources are for official docs, curated links, books, cheat sheets, labs, and practice platforms.
...
<a id="badge-library"></a>

## 🏅 Badge Library

The badge library stays visible, but organized with collapsible groups so the README remains readable.
